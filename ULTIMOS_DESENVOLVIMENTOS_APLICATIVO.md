...
1. Adicionar filtro para jogos nao instalados na biblioteca, preservando os filtros existentes e os estados de lista vazia.
2. Melhorar a visualizacao da tela de configuracoes/contas, deixando estados de Steam, Web API, sincronizacao local e providers planejados mais claros.
3. Depois, evoluir Steam com Web API para playtime/metadados adicionais e preparar consulta filtrada/paginacao no backend para bibliotecas maiores.
